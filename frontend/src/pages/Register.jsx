  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <h2 className="font-[var(--font-display)] text-3xl text-center text-[var(--color-ink)] mb-8">Create account</h2>
        <form onSubmit={onSubmit} className="bg-[var(--color-card)] border border-[var(--color-border-soft)] rounded-2xl p-8 space-y-6 shadow-sm">
          <div>
            <label className="text-base text-[var(--color-ink-soft)]">Name</label>
            <input
              required
              value={name}
